!function()
{
    ...
    var text = document.createTextNode("Тройка Пифагора");
    ...
    text = document.createTextNode("Если квадрат самого большого числа равен сумме квадратов двух остальных, то эти числа являются Тройкой Пифагора.");
    ...
    text = document.createTextNode("Третье число");
    ...
    input.classList.add("form-control");
    input.setAttribute("id", id);
    input.setAttribute("name", "third");
    input.setAttribute("placeholder", "Третье число");
    input.setAttribute("type", "number");
    ...
    text = document.createTextNode("Проверить");
